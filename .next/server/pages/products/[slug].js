...
ProductId.getInitialProps = async (context)=>{
    try {
        ...
        const index = (0,_util_util__WEBPACK_IMPORTED_MODULE_5__/* .findProductIndex */ .wC)(data, context.query.slug);
        return {
            product: data[index]
        };
    } catch (error) {
...
var __webpack_exports__ = __webpack_require__.X(0, [9505,1664,6330,9583,8866,4640], () => (__webpack_exec__(8672)));
