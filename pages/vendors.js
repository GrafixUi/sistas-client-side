                ...
                <div className="page-content pt-50">
                    <div className="container">
                        <div className="archive-header-2 text-center">
                            <h1 className="display-2 mb-50">Vendors Grid </h1>
                            <div className="row">
                        ...
                        <div className="row vendor-grid mt-10">
                            {data.map((item, i) => (
                                <div className="col-lg-3 col-md-6 col-12 col-sm-6" key={i}>
                                    <div className="vendor-wrap mb-40">
                                        ...
                                        <div className="vendor-content-wrap">
                                            ...
                                            <Link href={`vendor/${item.id}`}><a className="btn btn-xs mb-20">Visit Store <i className="fi-rs-arrow-small-right"></i></a></Link>
                                        </div>
                                    </div>
