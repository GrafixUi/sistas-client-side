            ...
            <div className="widget-area">
                ...
                <div className="sidebar-widget product-sidebar mb-50 p-30 bg-grey border-radius-10">
                    ...
                    <div className="single-post clearfix">
                        <div className="image">
                            <img src="/assets/imgs/shop/thumbnail-3.png" alt="#" />
                        </div>
                        <div className="content pt-10">
                            <h5><Link href="/shop-product-detail"><a>Black Tiered Smock Mini Dress</a></Link></h5>
                    ...
                    <div className="single-post clearfix">
                        <div className="image">
                            <img src="/assets/imgs/shop/thumbnail-4.png" alt="#" />
                        </div>
                        <div className="content pt-10">
                    ...
                    <div className="single-post clearfix">
                        <div className="image">
                            <img src="/assets/imgs/shop/thumbnail-5.png" alt="#" />
                        </div>
                        <div className="content pt-10">
                    ...
                    <div className="single-post clearfix">
                        <div className="image">
                            <img src="/assets/imgs/shop/thumbnail-6.png" alt="#" />
                        </div>
                        <div className="content pt-10">
                ...
                <div className="sidebar-widget widget-tags mb-50 pb-10">
                    ...
                    <ul className="tags-list">
                        <li className="hover-up">
                            <Link href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>Top Picks</a></Link>
                        </li>
                        <li className="hover-up">
                            <Link href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>New Arrivals</a></Link>
                        </li>
                        <li className="hover-up">
                            <Link href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>Ginger</a></Link>
                        </li>
                        <li className="hover-up">
                            <Link href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>Plus Size</a></Link>
                        </li>
                        <li className="hover-up mr-0">
                            <Link href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>Short</a></Link>
                        </li>
                        <li className="hover-up mr-0">
                            <Link href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>Jeans</a></Link>
                        </li>
                    </ul>
                </div>
